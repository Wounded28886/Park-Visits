...
from .const import (
    ...
    ATTR_OUR_DADS_RATING,
    ATTR_OUR_DISLIKED,
    ATTR_OUR_FACILITIES_RATING,
    ATTR_OUR_KIDS_RATING,
    ATTR_OUR_LIKED,
    ATTR_OUR_MUMS_RATING,
    ATTR_OUR_NOTE,
...
class ParkGeolocationEvent(CoordinatorEntity[ParkVisitsCoordinator], GeolocationEvent):
    ...
    def extra_state_attributes(self) -> dict[str, object]:
        ...
        return {
            ...
            ATTR_OUR_KIDS_RATING: park.our_kids_rating,
            ATTR_OUR_MUMS_RATING: park.our_mums_rating,
            ATTR_OUR_DADS_RATING: park.our_dads_rating,
